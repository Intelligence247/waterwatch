      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {features.map((feature, index) => {
            ...
            if (feature.large) {
              return (
                <AnimatedCard key={feature.title} className={feature.span} delay={delay}>
                  <div className="group rounded-2xl border border-slate-200 bg-slate-50 overflow-hidden hover:border-teal-300 hover:shadow-xl transition-all duration-500 relative h-full">
            ...
            if (feature.image) {
              return (
                <AnimatedCard key={feature.title} className={feature.span} delay={delay}>
                  <div className="group rounded-2xl border border-slate-200 bg-white overflow-hidden hover:border-teal-300 hover:shadow-lg transition-all duration-500 relative h-full">
            ...
            return (
              <AnimatedCard key={feature.title} className={feature.span} delay={delay}>
                <div className="group rounded-2xl border border-slate-200 bg-white p-7 hover:border-teal-300 hover:shadow-lg transition-all duration-500 relative flex flex-col justify-between h-full">
