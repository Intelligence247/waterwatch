          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div ref={ref} className="max-w-xl">
              ...
              <div className="flex items-center gap-3 mb-6 overflow-hidden">
                <div
                  className="h-px w-12 bg-teal-400 transition-all duration-700 ease-out"
                  style={{
                ...
                />
                <span
                  className="text-xs font-bold text-teal-300 tracking-wider uppercase transition-all duration-600 ease-out"
                  style={{
                    opacity: inView ? 1 : 0,
              ...
              {/* Headline */}
              <h2
                className="font-heading font-extrabold text-3xl sm:text-4xl lg:text-5xl text-white tracking-tight leading-tight transition-all duration-700 ease-out"
                style={{
                  opacity: inView ? 1 : 0,
              ...
              {/* Body */}
              <p
                className="mt-5 text-lg text-slate-300 leading-relaxed max-w-md transition-all duration-700 ease-out"
                style={{
                  opacity: inView ? 1 : 0,
                  transform: inView ? 'translateY(0)' : 'translateY(20px)',
