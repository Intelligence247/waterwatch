      ...
      <div className="hidden lg:flex lg:w-1/2 bg-teal-700 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <h1 className="font-heading font-800 text-3xl text-white tracking-tight mb-4">
            Your Community, Your Water
          </h1>
          <p className="text-teal-100 text-lg leading-relaxed">
            Sign in to report water issues, track repairs, and explore water points across Kwara State.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Access your citizen dashboard to report and track water issues.
          </p>
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            ...
            <Link to="/citizen/register" className="font-semibold text-teal-700 hover:text-teal-800 transition-colors">
              Create one
            </Link>
          </p>
